...
public class Quest17Test extends QuestTest {
    ...
    private static Stream<Arguments> provideTestDataForPart1() {
        return Stream.of(
                Arguments.of(List.of("189482189843433862719",
                        ...
                        "971977649141188759131"), 1573, null)
    ...
    private static Stream<Arguments> provideTestDataForPart2() {
        return Stream.of(
                Arguments.of(List.of("4547488458944",
                        "9786999467759",
                        "6969499575989",
                        "7775645848998",
                        "6659696497857",
                        ...
                        "6479994574886",
                        "6694118785585",
                        "9568991647449"), 1090, null)
        );
    }

    private static Stream<Arguments> provideTestDataForPart3() {
        return Stream.of(
                Arguments.of(List.of("2645233S5466644",
                        "634566343252465",
                        "353336645243246",
                        "233343552544555",
                        "225243326235365",
                        ...
                        "346225464436334",
                        "643362324542432",
                        "463332353552464"), 592, null),
                Arguments.of(List.of("2545233443422255434324",
                        ...
                        "553545434425235223552"), 330, null) ,
                Arguments.of(List.of("5441525241225111112253553251553",
                        ...
                        "3534343355355355553543545553345"), 3180, null)
