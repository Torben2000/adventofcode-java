...
public class Day17 extends Day {
    ...
    public Object part1(List<String> input) {
        Set<Pair<Integer, Integer>> hits = runLogic(input);
        int maxY = hits.stream().mapToInt(Pair::getValue1).max().orElseThrow();
    ...
    private Set<Pair<Integer, Integer>> runLogic(List<String> input) {
        ...
        Set<Pair<Integer, Integer>> hits = new HashSet<>();
